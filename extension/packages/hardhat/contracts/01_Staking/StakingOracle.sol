...
contract StakingOracle {
    ...
    uint256 public constant MISREPORT_PENALTY = 1000 ether;
    ...
    constructor() {
        oracleToken = new ORA();
        // Just so the deployer can set up the oracle nodes and act as a faucet for ORA tokens
        oracleToken.mint(msg.sender, 1000000000000 * 10 ** 18);
    }
     ...
     * @dev Requires at least 2/3 (rounded up) of active nodes to have submitted reports
