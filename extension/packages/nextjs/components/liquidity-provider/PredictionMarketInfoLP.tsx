      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border-default divide-x items-center">
        <div className="p-6">
          <h3 className="text-xl font-medium">
            Token Value:{" "}
            <span className="text-primary font-bold">{Number(formatEther(BigInt(tokenValue ?? 0))).toFixed(4)} Ξ</span>
          </h3>
        ...
        <div className="">
          <div className="grid grid-cols-1 md:grid-cols-2 border-default divide-x items-center">
            <div className="p-6">
              ...
              <div className="stat-value text-primary pt-2 font-bold text-xl">
