...
- [ ] 🥅 Before using the deposit function, check the required amount of $BAL tokens, which is equal to the amount of ETH you have entered for deposit by using the price function in debug tab.
