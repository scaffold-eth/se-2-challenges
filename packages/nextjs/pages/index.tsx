          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="max-w-3xl">
              <p className="text-center text-lg mt-8">
                ...
                requiring multiple accounts to "vote" on transactions. Think of it as a treasure chest that can only be
                opened when all key parties agree.
              </p>
              <p className="text-center text-lg">
                📜 The contract keeps track of all transactions. Each transaction can be confirmed or rejected by the
                signers (smart contract owners). Only transactions that receive enough confirmations can be "executed"
                by the signers.
              </p>
              <p className="text-center text-lg">
