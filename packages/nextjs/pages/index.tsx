        ...
        <div className="px-5 w-[90%] md:w-[75%]">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="max-w-3xl">
              ...
              This challenge will help you build/understand a simple decentralized exchange, with one token-pair (ERC20 BALLOONS ($BAL) and ETH). This repo is an updated version of the {" "}
                <a href="https://medium.com/@austin_48503/%EF%B8%8F-minimum-viable-exchange-d84f30bd0c90" target="_blank" rel="noreferrer" className="underline">
                original tutorial
